...
if __name__ == "__main__":
    from models import TemperatureReading, EnergyReading, DeviceTemperature
else:
    from dummy_api.ver2.models import TemperatureReading, \
        EnergyReading
...
if __name__ == "__main__":
    ...
    uvicorn.run("dummy_api.ver2.api:app", host="0.0.0.0", port=8010,
                reload=True)
